...
# if you don't have the data pickled run these two lines
...
# only use a percentage of the data to save time!
...
# train/test split
# -----------------------------------------------------------------------------
train_set_df, test_set_df = train_test_split(dfCleanPrecentToUse, test_size=0.2, random_state=987)
